...
pub use net::{
    ...
    LINUX_POLLPRI, LINUX_POLLRDBAND, LINUX_POLLRDNORM, LINUX_POLLWRBAND, LINUX_POLLWRNORM,
    LINUX_SHUT_RD, LINUX_SHUT_RDWR, LINUX_SHUT_WR, LINUX_SO_DEBUG, LINUX_SO_ERROR,

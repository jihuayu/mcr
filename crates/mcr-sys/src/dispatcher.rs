...
pub const SYSCALL_DISPATCH_TABLE: &[SyscallDescriptor] = &[
    ...
    SyscallDescriptor::new(Syscall::Pwritev2, SyscallSubsystem::File),
    ...
    SyscallDescriptor::new(Syscall::SchedGetparam, SyscallSubsystem::Task),
    SyscallDescriptor::new(Syscall::SchedGetscheduler, SyscallSubsystem::Task),
    ...
    SyscallDescriptor::new(Syscall::Fallocate, SyscallSubsystem::File),
...
pub fn decode_syscall_fields(syscall: Syscall, args: SyscallArgs) -> Vec<TraceField> {
    ...
    match syscall {
        ...
        Syscall::Pwritev2 => vec![
            decimal_field("fd", arg(0)),
            hex_field("iov", arg(1)),
            decimal_field("iovcnt", arg(2)),
            hex_field("pos_l", arg(3)),
            hex_field("pos_h", arg(4)),
            hex_field("flags", arg(5)),
        ],
        Syscall::Lseek => vec![
            decimal_field("fd", arg(0)),
        ...
        Syscall::Fallocate => vec![
            decimal_field("fd", arg(0)),
            hex_field("mode", arg(1)),
            signed_field("offset", arg(2)),
            signed_field("len", arg(3)),
        ],
        ...
        Syscall::SchedGetparam => vec![signed_field("pid", arg(0)), hex_field("param", arg(1))],
        Syscall::SchedGetscheduler => vec![signed_field("pid", arg(0))],

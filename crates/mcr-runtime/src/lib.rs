...
use mcr_sys::{
    ...
    LINUX_EPOLLPRI, LINUX_FUTEX_CLOCK_REALTIME, LINUX_FUTEX_CMP_REQUEUE, LINUX_FUTEX_REQUEUE,
    LINUX_FUTEX_WAIT, LINUX_FUTEX_WAIT_BITSET, LINUX_FUTEX_WAKE, LINUX_FUTEX_WAKE_BITSET,
    LINUX_KERNEL_SIGSET_SIZE, LINUX_MSG_CMSG_CLOEXEC, LINUX_MSG_DONTWAIT, LINUX_MSG_NOSIGNAL,
    LINUX_POLLERR, LINUX_POLLHUP, LINUX_POLLIN, LINUX_POLLNVAL, LINUX_POLLOUT, LINUX_POLLPRI,
    LINUX_POLLRDNORM, LINUX_POLLWRNORM, LinuxEpollEvent, LinuxErrno, LinuxIovec, LinuxPollfd,

...
#[cfg(windows)]
fn submit_connect_ex_platform(socket: &HostSocket, address: SocketAddr) -> HostConnectExSubmission {
...
#[cfg(windows)]
fn update_connect_context(socket: crate::windows::Socket) -> HostResult<()> {
    let status = unsafe {
...
#[cfg(windows)]
pub(super) const WSAID_ACCEPTEX: Guid = Guid {
    data1: 0xb536_7df1,
    data2: 0xcbac,
    data3: 0x11cf,
...
#[cfg(windows)]
pub(super) const WSAID_CONNECTEX: Guid = Guid {
    data1: 0x25a2_07b9,
    data2: 0xddf3,
    data3: 0x4660,
...
#[cfg(windows)]
#[derive(Debug)]
struct WindowsPendingConnectEx {

...
pub use network::{
    AddressFamily, HostConnectExSubmission, HostRioCapability, HostShutdown, HostSocket,
    ...
    PendingHostConnectEx, PendingHostSocketIo, SocketCompletionKind, SocketEvents,

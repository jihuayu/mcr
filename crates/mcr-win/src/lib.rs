...
pub use network::{
    AddressFamily, HostRioCapability, HostShutdown, HostSocket, HostSocketIoCompletion,
    HostSocketIoDirection, HostSocketIoFailure, HostSocketIoResult, HostSocketIoSubmission,
    HostSocketOptionName, HostSocketOptionValue, NetworkStack, PendingHostSocketIo,
